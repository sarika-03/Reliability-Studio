...
export const backendAPI = {
  ...
  incidents: {
    ...
    getIntelligence: (id: string) => apiFetch<any>(`/incidents/${id}/intelligence`),
    remediate: (id: string, action: { action_type: string, target: string, namespace: string }) =>
      apiFetch<any>(`/incidents/${id}/remediate`, { method: 'POST', body: action }),
  },
  services: {
  ...
  investigation: {
    ...
    getLogs: (incidentId: string) => apiFetch<any[]>(`/incidents/${incidentId}/investigation/logs`),
  }
};
